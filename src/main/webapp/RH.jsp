        ...
        <div id="principal">
            <div class="row">
                ...
                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 container-fluid"><!-- Seccion derecha (Visualizar tarea) -->
                    <div class="row">
                        <p style="padding: 10px 10px"><span style="margin-right: 10px;"><img border="0" height="50" width="50" src="Recursos/img/ic_area_recursos.png" /></span>Área Recursos humanos</p>
                    </div>
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 container-fluid"><!-- Seccion derecha (Visualizar tarea) -->
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        <td colspan="3">Su saldo de días libres es de <strong>0 días</strong></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 container-fluid"><!-- Seccion derecha (Visualizar tarea) -->
                            <table class="table table-bordered">
                                <thead class="titulos">
                                    <tr>
                                        <td colspan="2">Últimos 0 días retribuidos</td>
                                        <td>de</td>
                                        <td>a</td>
                                        <td>Fecha Modif.</td>
                                    </tr>
                            ...
                            <table class="table table-bordered">
                                <thead class="titulos">
                                    <tr>
                                        <td colspan="2">Últimos 0 informes de gatos modificados</td>
                                        <td>Total</td>
                                        <td>Fecha Modif.</td>
                                    </tr>
                                </thead>
