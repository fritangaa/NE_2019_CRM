        ...
        <div id="principal">
            <div class="row">
                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 container-fluid" style="background-color: #f8f8f8;"><!-- Seccion central (Visualizar tarea) -->
                    ...
                    <div  class="row">
                        <div class="list-group" style="width: 100%;">
                            ...
                            <button type="button" class="list-group-item list-group-item-action">Nuevo contrato/suscripción</button>
                            <button type="button" class="list-group-item list-group-item-action">Lista</button>
                ...
                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 container-fluid"><!-- Seccion derecha (Visualizar tarea) -->
                    <div class="row">
                        <p style="padding: 10px 10px"><span style="margin-right: 10px;"><img border="0" height="50" width="50" src="Recursos/img/ic_area_comercial.png" /></span>Área comercial</p>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 container-fluid"><!-- Seccion derecha (Visualizar tarea) -->
                            <table class="table table-bordered">
                                <thead class="titulos">
                                    <tr>
                                        <td colspan="2">Últimos 3 clientes o clientes potenciales</td>
                            ...
                            <table class="table table-bordered">
                                <thead class="titulos">
                                    <tr>
                                        <td colspan="2">Últimos 0 proveedores modificados</td>
                                        <td class = "text-right"><a href="#">Lista completa</a></td>
                                    </tr>
                                </thead>
                                <tbody>
                            ...
                            <table class="table table-bordered">
                                <thead class="titulos">
                                    <tr>
                                        <td colspan="2">Últimas 3 acciones completadas</td>
                                        <td class = "text-right"><a href="#">Lista completa</a></td>
                                    </tr>
                                </thead>
                            </table>
                            <table class="table table-bordered">
                                <thead class="titulos">
                                    <tr>
                                        <td colspan="2">10 acciones más antiguas por completar</td>
                                        <td class = "text-right"><a href="#">Lista completa</a></td>
                                    </tr>
                                </thead>
                            </table>
